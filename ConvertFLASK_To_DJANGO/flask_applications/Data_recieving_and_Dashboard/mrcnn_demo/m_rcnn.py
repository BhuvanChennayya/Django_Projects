...
from Data_recieving_and_Dashboard.mrcnn_demo.config import Config
from Data_recieving_and_Dashboard.mrcnn_demo import utils
import Data_recieving_and_Dashboard.mrcnn_demo.model as modellib
from Data_recieving_and_Dashboard.mrcnn_demo import visualize
from Data_recieving_and_Dashboard.mrcnn_demo.model import log
...
COCO_MODEL_PATH = os.path.join(str(os.getcwd())+"/panel_detection_models", "mask_rcnn_coco.h5")
